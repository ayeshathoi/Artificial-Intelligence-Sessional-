...
public class Main {
    ...
    private static void runSchemeOn(String fileName, String ch,int type) throws IOException {
        ...
        for(Course crs : courses) {
            fileWriter.append("CourseID: ").append(crs.courseID);
            fileWriter.append(" ScheduledDay : ").append(String.valueOf(crs.ScheduledDay));
            fileWriter.append("\n");
        }
    ...
    public static void main(String[] args) throws IOException {
        ...
        while(true) {
            ...
            System.out.println("1 to get LargestDegree\n" +
                    "2 to get DsaturAlgo\n" +
